...
public class SysFuncUiFieldRepository {
	 ...
	 * 
	 */
	public List<SysFuncUiField> queryByModelBetweenSize(final SysFuncUiField model, String orderByColNm1,
	...
	public long queryCount(SysFuncUiField model) throws Exception {
		...
		try {
			...
			// SysFuncUiFieldMapper mapper =
			// sqlSession.getMapper(SysFuncUiFieldMapper.class);
	 ...
	 * @throws Exception
	 */
	// public int update(final SysFuncUiField model, SqlSession sqlSession) throws
	// Exception {
	// SysFuncUiFieldMapper mapper =
	// sqlSession.getMapper(SysFuncUiFieldMapper.class);
	// return mapper.updateByPrimaryKey(model);
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<SysFuncUiField> modelList) throws Exception {
		SqlSession sqlSession = mybatis.createSqlSessionFactory().openSession();
		int count = 0;
	 ...
	 */
	public List<SysFuncUiField> queryBySysFuncUiField(final SysFuncUiField model) throws Exception {
		SqlSession sqlSession = mybatis.createSqlSessionFactory().openSession();
		List<SysFuncUiField> returnList = null;
		try {
			SysFuncUiFieldMapper mapper = sqlSession.getMapper(SysFuncUiFieldMapper.class);
...
//            }
	...
	// * @throws Exception
	// */
	// public List<SysFuncUiField> queryDistint{COL_NM}(SqlSession sqlSession)
	/// throws Exception {
	// List<SysFuncUiField> returnList = null;
	//
	// SysFuncUiFieldMapper mapper =
