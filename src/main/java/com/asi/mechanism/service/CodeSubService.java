...
import com.asi.mechanism.service.repository.CodeSubRepository;

@Service
public class CodeSubService {

	private Log log = LogFactory.getLog(CodeSubService.class);

	@Autowired
	private CodeSubRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final CodeSub model, CodeSubMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final CodeSub model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final CodeSub model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<CodeSub> modelList)
			throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜CodeSub＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<CodeSub> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public CodeSub queryByJobId(final String jobId) throws Exception
    // {
     ...
     * @throws Exception
     */
    public List<CodeSub> queryByCodeSub(final CodeSub model)
            throws Exception
    {
        return repository.queryByCodeSub(model);
    }
     ...
     * @throws Exception
     */
    public List<CodeSub> queryByCodeSub(final CodeSub model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByCodeSub(model, sqlSession);
    }
...
//     * @throws Exception
//     */
//    public List<CodeSub> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
