...
import com.asi.mechanism.service.repository.SysRoleRepository;
...
public class SysRoleService {
	 ...
	 * @throws Exception
	 */
	public int updateModifyPk(SysRole pkModel, SysRole newPkModel, SysRoleMapper mapper) throws Exception {
