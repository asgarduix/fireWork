...
import com.asi.mechanism.service.repository.SysAccessRecordRepository;

@Service
public class SysAccessRecordService {

	private Log log = LogFactory.getLog(SysAccessRecordService.class);

	@Autowired
	private SysAccessRecordRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final SysAccessRecord model, SysAccessRecordMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final SysAccessRecord model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final SysAccessRecord model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<SysAccessRecord> modelList)
			throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜SysAccessRecord＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<SysAccessRecord> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public SysAccessRecord queryByJobId(final String jobId) throws Exception
    // {
     ...
     * @throws Exception
     */
    public List<SysAccessRecord> queryBySysAccessRecord(final SysAccessRecord model)
            throws Exception
    {
        return repository.queryBySysAccessRecord(model);
    }
    ...
    public List<SysAccessRecord> queryBySysAccessRecord(final SysAccessRecord model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryBySysAccessRecord(model, sqlSession);
    }
   ...
   // * @throws Exception
   // */
   //public List<SysAccessRecord> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
