...
public class SysAccountService {
	 ...
	 * @throws Exception
	 */
	//public int insert(final SysAccount model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final SysAccount model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<SysAccount> modelList)
			throws Exception {
     ...
     * @throws Exception
     */
    public List<SysAccount> queryBySysAccount(final SysAccount model)
            throws Exception
    {
     ...
     * @throws Exception
     */
    public List<SysAccount> queryBySysAccount(final SysAccount model, SqlSession sqlSession)
            throws Exception
    {
   ...
   // * @throws Exception
   // */
   //public List<SysAccount> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
