...
import com.asi.huanan.service.repository.LogFriFacSharesRepository;

@Service
public class LogFriFacSharesService {

	private Log log = LogFactory.getLog(LogFriFacSharesService.class);

	@Autowired
	private LogFriFacSharesRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final LogFriFacShares model, LogFriFacSharesMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final LogFriFacShares model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜LogFriFacShares＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<LogFriFacShares> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public LogFriFacShares queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<LogFriFacShares> queryByLogFriFacShares(final LogFriFacShares model)
            throws Exception
    {
        return repository.queryByLogFriFacShares(model);
    }
    ...
    public List<LogFriFacShares> queryByLogFriFacShares(final LogFriFacShares model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByLogFriFacShares(model, sqlSession);
    }
