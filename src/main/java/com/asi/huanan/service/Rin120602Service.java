...
@Service
public class Rin120602Service {

	private Log log = LogFactory.getLog(Rin120602Service.class);

	@Autowired
	private Rin120602Repository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final Rin120602 model, Rin120602Mapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final Rin120602 model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜Rin120602＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<Rin120602> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public Rin120602 queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<Rin120602> queryByRin120602(final Rin120602 model)
            throws Exception
    {
        return repository.queryByRin120602(model);
    }
    ...
    public List<Rin120602> queryByRin120602(final Rin120602 model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByRin120602(model, sqlSession);
    }
