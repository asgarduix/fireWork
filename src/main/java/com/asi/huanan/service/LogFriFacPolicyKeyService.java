...
import com.asi.huanan.service.repository.LogFriFacPolicyKeyRepository;

@Service
public class LogFriFacPolicyKeyService {

	private Log log = LogFactory.getLog(LogFriFacPolicyKeyService.class);

	@Autowired
	private LogFriFacPolicyKeyRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final LogFriFacPolicyKey model, LogFriFacPolicyMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final LogFriFacPolicyKey model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜LogFriFacPolicyKey＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<LogFriFacPolicyKey> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public LogFriFacPolicyKey queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<LogFriFacPolicyKey> queryByLogFriFacPolicyKey(final LogFriFacPolicyKey model)
            throws Exception
    {
        return repository.queryByLogFriFacPolicyKey(model);
    }
    ...
    public List<LogFriFacPolicyKey> queryByLogFriFacPolicyKey(final LogFriFacPolicyKey model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByLogFriFacPolicyKey(model, sqlSession);
    }
