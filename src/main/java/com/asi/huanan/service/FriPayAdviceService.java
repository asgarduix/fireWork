...
@Service
public class FriPayAdviceService {

	private Log log = LogFactory.getLog(FriPayAdviceService.class);

	@Autowired
	private FriPayAdviceRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final FriPayAdvice model, FriPayAdviceMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriPayAdvice model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriPayAdvice＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriPayAdvice> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriPayAdvice queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<FriPayAdvice> queryByFriPayAdvice(final FriPayAdvice model)
            throws Exception
    {
        return repository.queryByFriPayAdvice(model);
    }
    ...
    public List<FriPayAdvice> queryByFriPayAdvice(final FriPayAdvice model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriPayAdvice(model, sqlSession);
    }
