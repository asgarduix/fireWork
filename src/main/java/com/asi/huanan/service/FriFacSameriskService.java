...
import com.asi.huanan.service.repository.FriFacSameriskRepository;

@Service
public class FriFacSameriskService {

	private Log log = LogFactory.getLog(FriFacSameriskService.class);

	@Autowired
	private FriFacSameriskRepository repository;
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriFacSamerisk model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final FriFacSamerisk model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<FriFacSamerisk> modelList)
			throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriFacSamerisk＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriFacSamerisk> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriFacSamerisk queryByJobId(final String jobId) throws Exception
    // {
    ...
    /**
     * 
     * @param FriFacSamerisk
     * @return
     * @throws Exception
     */
    public List<FriFacSamerisk> queryByFriFacSamerisk(final FriFacSamerisk model)
            throws Exception
    {
        return repository.queryByFriFacSamerisk(model);
    }
    ...
    public List<FriFacSamerisk> queryByFriFacSamerisk(final FriFacSamerisk model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriFacSamerisk(model, sqlSession);
    }
    ...
    */
     ...
     * @throws Exception
     */
//    public List<FriFacSamerisk> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
