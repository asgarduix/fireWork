...
import com.asi.huanan.service.repository.LogFriFacRepository;

@Service
public class LogFriFacService {

	private Log log = LogFactory.getLog(LogFriFacService.class);

	@Autowired
	private LogFriFacRepository repository;
	 ...
	 * @throws Exception
	 */
	//public int insert(final LogFriFac model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜LogFriFac＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<LogFriFac> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public LogFriFac queryByJobId(final String jobId) throws Exception
    // {
