...
import com.asi.huanan.service.repository.FriFacNpropRepository;

@Service
public class FriFacNpropService {

	private Log log = LogFactory.getLog(FriFacNpropService.class);

	@Autowired
	private FriFacNpropRepository repository;
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriFacNprop model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final FriFacNprop model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<FriFacNprop> modelList)
			throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriFacNprop＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriFacNprop> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriFacNprop queryByJobId(final String jobId) throws Exception
    // {
     ...
     * @throws Exception
     */
    public List<FriFacNprop> queryByFriFacNprop(final FriFacNprop model)
            throws Exception
    {
        return repository.queryByFriFacNprop(model);
    }
     ...
     * @throws Exception
     */
    public List<FriFacNprop> queryByFriFacNprop(final FriFacNprop model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriFacNprop(model, sqlSession);
    }
    ...
    {
		return repository.deleteByFriFacNprop(model,mapper);
    }
    ...
    */
     ...
     * @throws Exception
     */
//    public List<FriFacNprop> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
