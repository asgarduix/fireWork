...
import com.asi.huanan.service.repository.FriComCreditRepository;

@Service
public class FriComCreditService {

	private Log log = LogFactory.getLog(FriComCreditService.class);

	@Autowired
	private FriComCreditRepository repository;
     ...
     * @throws Exception
     */
    public List<FriComCredit> queryCredit(final String rinComId)
            throws Exception
    {
        return repository.queryCredit(rinComId);
    }
	 ...
	 * @throws Exception
	 */
	public int insert(final FriComCredit model, FriComCreditMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriComCredit model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriComCredit＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriComCredit> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriComCredit queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<FriComCredit> queryByFriComCredit(final FriComCredit model)
            throws Exception
    {
        return repository.queryByFriComCredit(model);
    }
    ...
    public List<FriComCredit> queryByFriComCredit(final FriComCredit model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriComCredit(model, sqlSession);
    }
