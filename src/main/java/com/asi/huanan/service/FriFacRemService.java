...
import com.asi.huanan.service.repository.FriFacRemRepository;

@Service
public class FriFacRemService {

	private Log log = LogFactory.getLog(FriFacRemService.class);

	@Autowired
	private FriFacRemRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final FriFacRem model, FriFacRemMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriFacRem model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriFacRem＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriFacRem> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriFacRem queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<FriFacRem> queryByFriFacRem(final FriFacRem model)
            throws Exception
    {
        return repository.queryByFriFacRem(model);
    }
    ...
    public List<FriFacRem> queryByFriFacRem(final FriFacRem model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriFacRem(model, sqlSession);
    }
