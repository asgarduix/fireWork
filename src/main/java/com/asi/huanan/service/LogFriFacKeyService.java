...
import com.asi.huanan.service.repository.LogFriFacKeyRepository;

@Service
public class LogFriFacKeyService {

	private Log log = LogFactory.getLog(LogFriFacKeyService.class);

	@Autowired
	private LogFriFacKeyRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final LogFriFac model, LogFriFacMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final LogFriFacKey model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜LogFriFacKey＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<LogFriFacKey> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public LogFriFacKey queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<LogFriFac> queryByLogFriFac(final LogFriFac model)
            throws Exception
    {
        return repository.queryByLogFriFac(model);
    }
     ...
     * @throws Exception
     */
    public List<LogFriFac> queryByLogFriFacKey(final LogFriFac model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByLogFriFac(model, sqlSession);
    }
