...
public class FriTreatyShareOrderService {
	...
	private Log log = LogFactory.getLog(FriTreatyShareOrderService.class);

	@Autowired
	private FriTreatyShareOrderRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final FriTreatyShareOrder model, FriTreatyShareOrderMapper mapper) throws Exception {
	...
	// * @param modelList
	// * @return
	// Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriTreatyShareOrder＞)
	// * @throws Exception
	// */
	// public Map<String, Object> insertList(List<FriTreatyShareOrder> modelList)
	// throws Exception
	// {
	// return repository.insertList(modelList);
	// }
	...
	// * @throws Exception
	// */
	// public FriTreatyShareOrder queryByJobId(final String jobId) throws Exception
	// {
	...
	public List<FriTreatyShareOrder> queryByFriTreatyShareOrder(final FriTreatyShareOrder model, SqlSession sqlSession)
			throws Exception {
		return repository.queryByFriTreatyShareOrder(model, sqlSession);
	}
...
//     * @throws Exception
//     */
//    public List<FriTreatyShareOrder> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
