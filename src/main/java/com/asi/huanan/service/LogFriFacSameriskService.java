...
import com.asi.huanan.service.repository.LogFriFacSameriskRepository;

@Service
public class LogFriFacSameriskService {

	private Log log = LogFactory.getLog(LogFriFacSameriskService.class);

	@Autowired
	private LogFriFacSameriskRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final LogFriFacSamerisk model, LogFriFacSameriskMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final LogFriFacSamerisk model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜LogFriFacSamerisk＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<LogFriFacSamerisk> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public LogFriFacSamerisk queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<LogFriFacSamerisk> queryByLogFriFacSamerisk(final LogFriFacSamerisk model)
            throws Exception
    {
        return repository.queryByLogFriFacSamerisk(model);
    }
    ...
    public List<LogFriFacSamerisk> queryByLogFriFacSamerisk(final LogFriFacSamerisk model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByLogFriFacSamerisk(model, sqlSession);
    }
