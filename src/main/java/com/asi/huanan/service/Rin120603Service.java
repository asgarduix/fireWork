...
@Service
public class Rin120603Service {

	private Log log = LogFactory.getLog(Rin120603Service.class);

	@Autowired
	private Rin120603Repository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final Rin120603 model, Rin120603Mapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final Rin120603 model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜Rin120603＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<Rin120603> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public Rin120603 queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<Rin120603> queryByRin120603(final Rin120603 model)
            throws Exception
    {
        return repository.queryByRin120603(model);
    }
    ...
    public List<Rin120603> queryByRin120603(final Rin120603 model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByRin120603(model, sqlSession);
    }
