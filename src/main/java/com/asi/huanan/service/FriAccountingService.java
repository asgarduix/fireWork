...
@Service
public class FriAccountingService {

	private Log log = LogFactory.getLog(FriAccountingService.class);

	@Autowired
	private FriAccountingRepository repository;
	 ...
	 * @throws Exception
	 */
	public int deleteChangeStatusRin1303(final String slipNo, FriAccountingMapper mapper) throws Exception {
		return repository.deleteChangeStatusRin1303(slipNo, mapper);
	}
	 ...
	 * @throws Exception
	 */
	public int insert(final FriAccounting model, FriAccountingMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final FriAccounting model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int update(final FriAccounting model, SqlSession sqlSession) throws Exception {
	 ...
	 * @throws Exception
	 */
	public int insertList(final List<FriAccounting> modelList)
			throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜FriAccounting＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<FriAccounting> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public FriAccounting queryByJobId(final String jobId) throws Exception
    // {
     ...
     * @throws Exception
     */
    public List<FriAccounting> queryByFriAccounting(final FriAccounting model)
            throws Exception
    {
        return repository.queryByFriAccounting(model);
    }
     ...
     * @throws Exception
     */
    public List<FriAccounting> queryByFriAccounting(final FriAccounting model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByFriAccounting(model, sqlSession);
    }
...
//     * @throws Exception
//     */
//    public List<FriAccounting> queryDistint{COL_NM}(SqlSession sqlSession) throws Exception {
...
//    }
    ...
    public List<FriAccounting> queryForRin1303No4(String slipNo) throws Exception{
    	return repository.queryForRin1303No4(slipNo);
    }
}