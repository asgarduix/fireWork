...
import com.asi.huanan.service.dao.mybatis.model.LogFriFacSlipriskExample.Criteria;
...
@Repository
public class LogFriFacSlipriskKeyRepository {

	private Log log = LogFactory.getLog(LogFriFacSlipriskKeyRepository.class);
	...
	public long queryCount(LogFriFacSlipriskKey model) throws Exception {
		...
		try {
			if(model == null) {
				LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
	 ...
	 * @return
	 */
	public int insert(final LogFriFacSlipriskKey model, LogFriFacSlipriskMapper mapper) {
	 ...
	 * @return
	 */
	//public int insert(final LogFriFacSlipriskKey model, SqlSession sqlSession) {
	//	LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
	//	return mapper.insertSelective(model);
	//}
	...
	public int insertList(final List<LogFriFacSlipriskKey> modelList)
		...
		try {
			LogFriFacSlipriskMapper mapper = sqlSession
					.getMapper(LogFriFacSlipriskMapper.class);

			for (LogFriFacSlipriskKey model : modelList) {
				//count += mapper.insertSelective(model);
			}
    ...
    // /**
    // *
    // * @return List<LogFriFacSlipriskKey>
    // * @throws Exception
    // */
    // public List<LogFriFacSlipriskKey> queryByJobId(final String jobId)
    // throws Exception {
    // SqlSession sqlSession = mybatis.createSqlSessionFactory().openSession();
    // List<LogFriFacSlipriskKey> returnList = null;
    // try {
    // LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
    // LogFriFacSlipriskKeyExample ex = new LogFriFacSlipriskKeyExample();
    ...
    //  * 
    //  * @param key
    //  * @return LogFriFacSlipriskKey
    //  * @throws Exception
    //  */
    // public LogFriFacSlipriskKey queryByJobId(final String id) throws Exception
    // {
    //     SqlSession sqlSession = mybatis.createSqlSessionFactory().openSession();
    //     List<LogFriFacSlipriskKey> returnList = null;
    //     try
    //     {
    //         LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
    //         //LogFriFacSlipriskKeyExample xp = new LogFriFacSlipriskKeyExample();
            ...
            throws Exception
    {
        ...
        {
            LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
            LogFriFacSlipriskExample xp = new LogFriFacSlipriskExample();
            Criteria criteria = xp.createCriteria();
...
//            log.debug(returnList == null ? "returnList is null" : "筆數:" + returnList.size());
	...
	*/
	public List<LogFriFacSlipriskKey> queryAll() throws Exception {
		SqlSession sqlSession = mybatis.createSqlSessionFactory().openSession();
		List<LogFriFacSlipriskKey> result = null;
		try {
			LogFriFacSlipriskMapper mapper = sqlSession.getMapper(LogFriFacSlipriskMapper.class);
	...
	*/
	...
	//	int result = 0;
	//	try {
	//		LogFriFacSlipriskMapper mapper = session.getMapper(LogFriFacSlipriskMapper.class);
