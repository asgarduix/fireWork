...
import com.asi.huanan.service.repository.PropNameRepository;

@Service
public class PropNameService {

	private Log log = LogFactory.getLog(PropNameService.class);

	@Autowired
	private PropNameRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final PropName model, PropNameMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	//public int insert(final PropName model, SqlSession sqlSession) throws Exception {
    ...
    // *
    // * @param modelList
    // * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜PropName＞)
    // * @throws Exception
    // */
    // public Map<String, Object> insertList(List<PropName> modelList)
    // throws Exception
    // {
    // return repository.insertList(modelList);
    // }
    ...
    //  * @throws Exception
    //  */
    // public PropName queryByJobId(final String jobId) throws Exception
    // {
    ...
    public List<PropName> queryByPropName(final PropName model)
            throws Exception
    {
        return repository.queryByPropName(model);
    }
    ...
    public List<PropName> queryByPropName(final PropName model, SqlSession sqlSession)
            throws Exception
    {
        return repository.queryByPropName(model, sqlSession);
    }
