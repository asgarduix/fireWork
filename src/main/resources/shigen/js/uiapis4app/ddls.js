...
function ddlRptType(id) {
    ...
    $(elementId)[0].innerHTML = optionParam;
}
...
function openSelectWindow(id, options, w, h) {
    ...
    newWindow.innerHTML = `<select onchange='window.opener.setValue("${id}",this.value);'>`;
    for (let i = 0; i < options.length; i++) {
        //newWindow.document.write("<option value='" + options[i].value + "'>");
        //newWindow.document.write(options[i].text);
        //newWindow.document.write("</option>");
        newWindow.innerHTML = "<option value='" + options[i].value + "'>";
        newWindow.innerHTML = options[i].text;
        newWindow.innerHTML = "</option>"
    }
    //newWindow.document.write("</select>");
    newWindow.innerHTML = "</select>"
}
...
function openInputWindow(id, w, h) {
    ...
    newWindow.innerHTML = `<input onchange='window.opener.setValue("${id}", this.value);'/>`;
}
