 ...
 */
 ...
 /**
  * 輸入鄉鎮代號 自動顯示 城市代號+鄉鎮名稱
  * @param monitorInput ->鄉鎮代號
  * @returns
  */
 ...
 //        //for HAS3080000顯示年齡(yiting)
 //        $('#txtIinsAge').removeClass('clearable')
 //    })
 //});
  ...
  * registerReportJob
  */
 //function registerReportJob(url, jsonObj, nameType, reportFunName, reportName, crtid){
 //	var param = {
 //			"paramJsonStr":JSON.stringify(jsonObj),
 //			"url":url,
 //			"nameType":nameType,
 //			"reportFunName":reportFunName,
  ...
  * @returns
  */
 function getArithmetic(preOne, afterOne, operator){
