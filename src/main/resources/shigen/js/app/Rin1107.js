...
let fieldName1107 = [
	...
	["txtrisk_no_1", "同險編號", "custom", { validator: ["minLength:11", "maxLength:20"],widthGrow:1 } ],
    ["txtrisk_name", "同險名稱", "custom", { validator: ["required"], widthGrow:2 } ],
    ["txtarea_code", "地段代碼", "custom", { validator: ["required"], widthGrow:1  } ]
];
