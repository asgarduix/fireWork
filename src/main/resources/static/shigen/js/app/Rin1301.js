...
let detailBtn = [{
    ...
    func: function(row) {
        ...
        let param = {
            ...
            "conversionStatus": row.getData().conversionStatus	// 會計轉檔狀況
        }
...
function genParam(value) {
    ...
    switch (value) {
        ...
        case "4":
            ...
            if(!checkIsNullSpace(policyDprtBgn) && !isValidDate(policyDprtBgn)){
    			errorMsg += "起日格式不符合西元年/月/日";
    		}
            if(!checkIsNullSpace(policyDprtEnd) && !isValidDate(policyDprtEnd)){
